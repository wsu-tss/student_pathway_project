...
def network_graph(matrix, units, figure_size=(50,50), color_node="red", color_edges="Blues", resolution=500, file_location="images/network_results/", label_position=0.3, edge_width=2, layout_type="circular", node_labels=True):
    ...
    color_edges -- cmap color used in matplotlib used for different shades of color
    ...
    nx.draw(G, pos=position, with_labels=node_labels, connectionstyle='arc3, rad=0.1', edge_list=edges, node_color=color_node, edge_color=weights, width=2, edge_cmap=plt.get_cmap(color_edges))
